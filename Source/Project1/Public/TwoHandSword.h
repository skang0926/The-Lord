...
UCLASS()
class PROJECT1_API ATwoHandSword : public AWeapon
{
	GENERATED_BODY()
...
public:	
	...
	UStaticMeshComponent* twoHandSword;
...
private:
	...
	UPROPERTY(VisibleAnywhere)
	TArray<UParticleSystemComponent*> electronicAttackEffectComponentArr;

	UPROPERTY(VisibleAnywhere)
	UParticleSystemComponent* electronicParticleComponent;
